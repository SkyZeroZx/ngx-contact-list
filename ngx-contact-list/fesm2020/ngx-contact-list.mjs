...
import { Pipe, EventEmitter, TemplateRef, Component, ContentChild, ViewChild, Input, Output, NgModule } from '@angular/core';
...
NgxContactListComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.1", ngImport: i0, type: NgxContactListComponent, deps: [{ token: FilterPipe }, { token: i0.Renderer2 }, { token: i2.FormBuilder }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.1", ngImport: i0, type: NgxContactListComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: FilterPipe }, { type: i0.Renderer2 }, { type: i2.FormBuilder }]; }, propDecorators: { templateRef: [{
                type: ContentChild,
                args: [TemplateRef]
            }], inputBodyEl: [{
                type: ViewChild,
...
class NgxContactListModule {
}
NgxContactListModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.1", ngImport: i0, type: NgxContactListModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
NgxContactListModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.2.1", ngImport: i0, type: NgxContactListModule, declarations: [NgxContactListComponent, FilterPipe], imports: [CommonModule, ReactiveFormsModule], exports: [NgxContactListComponent] });
NgxContactListModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.2.1", ngImport: i0, type: NgxContactListModule, providers: [FilterPipe], imports: [CommonModule, ReactiveFormsModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.1", ngImport: i0, type: NgxContactListModule, decorators: [{
            type: NgModule,
            args: [{
...
export { NgxContactListComponent, NgxContactListModule };
//# sourceMappingURL=ngx-contact-list.mjs.map
